...
public class GuestCreatedMapActivity extends AppCompatActivity {
    ...
    private static String TAG = "guest_created_map";

    String jsonString;
    ArrayList<String> guestMap = new ArrayList<>();

    RelativeLayout guestCreatedMapLayout;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guestcreatedmap);
        ...
        guestCreatedMapLayout = (RelativeLayout) findViewById(R.id.guestCreatedMapLayout);
        ...
        GuestCreatedMapActivity.GetData task = new GuestCreatedMapActivity.GetData();
        task.execute("http://" + IP_ADDRESS + "/myMap.php");

        GuestCreatedMapActivity.GetAvatarData g_avatarTask = new GuestCreatedMapActivity.GetAvatarData();
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(GuestCreatedMapActivity.this, "Please Wait", null, true, true);
        }
    ...
    private void showResult() {
        ...
        try {
            ...
            String imgPath = getCacheDir() + "/" + guestMap.get(position);
            Bitmap bm = BitmapFactory.decodeFile(imgPath);
            Drawable d = new BitmapDrawable(bm);
            guestCreatedMapLayout.setBackground(d);
